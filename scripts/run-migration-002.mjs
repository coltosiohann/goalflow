...
console.log('🚀 Running migration 002_enhance_tasks_content.sql...\n');

// Read migration SQL
const migrationPath = join(__dirname, '../supabase/migrations/002_enhance_tasks_content.sql');
...
console.log('Or copy from: supabase/migrations/002_enhance_tasks_content.sql\n');
